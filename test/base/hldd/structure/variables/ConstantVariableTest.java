...
public class ConstantVariableTest {
	...
	public void testSubRange() throws HLDDException {
		...
		assertEquals(const0.toString(), const0100.subRange(new Indices(3, 3)).toString());
		assertEquals(const1.toString(), const0100.subRange(new Indices(2, 2)).toString());
		assertEquals(const10.toString(), const0100.subRange(new Indices(2, 1)).toString());
		assertEquals(const100.toString(), const0100.subRange(new Indices(2, 0)).toString());
		assertEquals(const01.toString(), const0100.subRange(new Indices(3, 2)).toString());
		assertEquals(const010.toString(), const0100.subRange(new Indices(3, 1)).toString());
		assertEquals(const0100.toString(), const0100.subRange(new Indices(3, 0)).toString());
