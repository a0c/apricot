...
public class PackageParser {
    ...
    public static TypeAndValueHolder parseType(String typeString, AbstractPackageBuilder builder) throws Exception {
        ...
        if (typeString.startsWith("ARRAY ")) {
            ...
            return new TypeAndValueHolder(Type.createFromValues(valueRange), valueInt); /*todo: , valueRange.isDescending() ? */   // todo: <== isDescenging() for #length#
            ...
            return new TypeAndValueHolder(Type.BOOL_TYPE, valueInt);
