...
public class TabbedPaneListener extends MouseSelectionAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (isClickMePanel(source)) {
            ...
            SingleFileSelector fileSelector = SingleFileSelector.getInstance(SingleFileSelector.DialogType.OPEN_DIALOG,
            ...
            if (fileSelector.isFileSelected()) {
                ...
                applicationForm.addFileViewerTabFromFile(selectedFile, null/*java.util.Collections.singleton(20)*/, null/*java.util.Collections.singleton(10)*/, tabbedPane);
            }
        } else {
