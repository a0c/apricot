...
public class SimulationFrame extends JFrame {
    ...
    private JComponent createPanel(long[][] variableValuesArray, char[][] assertionValuesArray,
        ...
        return mainPanel/*linesScrollPane*/;
    }
    ...
    public void setVisible() {
        ...
        UniversalFrameLocator.topFrame(this);
        setVisible(true);
    }

    public static void main(String[] args) throws IOException {
        AssertionCheckReader checkReader = AssertionCheckReader.readFile("D:\\Documents and Settings\\Randy\\My Documents\\Anton\\TTU\\RAIK\\VERTIGO docs\\DEMO\\beh_simul\\P5.chk");

        new SimulationFrame(checkReader.getVariablePatterns(), checkReader.getAssertionPatterns(), null,
                checkReader.getBooleanIndices(), checkReader.getPatternsSize(), "P5.chk").setVisible();
    }
}
