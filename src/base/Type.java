...
//    private final int offset;
    ...
    /**
     * @param valueRange range of possible values in case of enums; <code>null</code> if not enum.
     * @param length physical length of variable/register. This defines the highestSB.
     */
...
//        return length.toStringAngular(false);
    ...
    public boolean equals(Object obj) {
        ...
        /* Here both are either enums or not enum */
        if (isEnum()) {
    ...
    public String toString() {
        ...
        b.append(length.toStringAngular(false));
        if (isEnum()) {
            b.append(" (ENUM=");
            b.append(valueRange.toString());
            b.append(");");
        }
        return b.toString();
    }
    ...
    public static Type createFromValues(Indices valueRange) {
        ...
        return new Type(valueRange, length); /*todo: , valueRange.isDescending() ? */   // todo: <== isDescenging() for #length#     <=== see in VHDLStructureParser.parseType()
    }
