...
//        }
    ...
    /**
     * Checks whether the Variables with the names specified by operanNames are
     * set in the tree before the specified operandNode. If they weren't then
     * the operants' D-flags are activated and the operands are removed from
     * varNames.
     * @param operandNames names of the operands to check
     * @param operandNode node where the specified operands originate from
     * @throws Exception if
     *         {@link #wasVariableSet(String, base.vhdl.structure.nodes.AbstractNode)}
     *         throws an Exception.
     */
