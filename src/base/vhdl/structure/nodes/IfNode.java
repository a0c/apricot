...
//        ifCondition = condition;
    ...
    public void setTruePart(CompositeNode truePart, IfNode parentNode) {
        this.truePart = truePart;
        this.truePart.setParent(parentNode);
    }
    ...
    public boolean isIdenticalTo(AbstractNode comparedNode) {
        ...
        /* Compare EXPRESSIONS */
//        if (!ifCondition.isIdenticalTo(comparedIfNode.getIfCondition())) return false;
